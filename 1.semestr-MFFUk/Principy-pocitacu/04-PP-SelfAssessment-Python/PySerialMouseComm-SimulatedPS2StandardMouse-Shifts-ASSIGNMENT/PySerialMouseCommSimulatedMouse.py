...
while not done:
    ...
    if len(nextByte) == 1:
        ...
        if len(pkt) == 3:  # We got the whole 3 byte packet, start processing it ...
            ...
            xSA4 = 0      # TODO: Modify this line to solve self-assessment assignment 11 for 4th lecture
            ((pkt[0] & 0x10) << 4) | pkt[1]
            ...
            ySA4 = ((pkt[0] & 0x20) << 3) | pkt[2]      # TODO: Modify this line to solve self-assessment assignment 11 for 4th lecture
            ySA4 = np.int16(ySA4)
            xSA4 = np.int16(xSA4)
