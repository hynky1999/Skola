...
print("*** and program will display them on set of simulated 7-segment displays:");
print("***   a) in decimal system implicitly, or")
print("***   b) in hexadecimal system, if the number is followed by '>h' characters ('greater than', and 'small H').")
print()
